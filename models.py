...
class AM_U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        super(AM_U_Net,self).__init__()
        ...
        self.Sigmoid = nn.Sigmoid()  # Add sigmoid activation for the output
    ...
    def forward(self,x):
        ...
        d1 = self.Conv_1x1(d2)
        d1 = self.Sigmoid(d1)  # Apply sigmoid to the output

        return d1

class R2_AM_U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1,t=2):
        super(R2_AM_U_Net,self).__init__()
